...
# oc set env deployment/apollo-backend PRISMA_ENDPOINT=http://prisma-development.apps-crc.testing
# oc set env deployment/apollo-backend PRISMA_SECRET=prisma
oc set env deployment/apollo-backend WHITELIST=""http://prisma-development.apps-crc.testing", "prisma-development.apps-crc.testing", "http://172.25.16.144:4466", 172.30.52.150, "apollo-backend-development.apps-crc.testing", "http://apollo-backend-development.apps-crc.testing", 172.25.128.169, "frontend-development.apps-crc.testing", "http://frontend-development.apps-crc.testing", "http:checkout.stripe.com/""
...
oc set env deployment/apollo-backend FRONTEND_URL=http://frontend-dev.apps-crc.testing
oc set env deployment/apollo-backend FRONTEND_IP=http://172.25.128.169:7777
oc set env deployment/apollo-backend BACKEND_URL=http://apollo-backend-dev.apps-crc.testing
