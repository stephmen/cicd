...
oc set env deployment/apollo-backend WHITELIST=""http://prisma-testing.apps-crc.testing", "prisma-testing.apps-crc.testing", "http://172.25.13.70:4466", 172.25.157.28, "apollo-backend-testing.apps-crc.testing", "http://apollo-backend-testing.apps-crc.testing", 172.25.9.137, "frontend-testing.apps-crc.testing", "http://frontend-testing.apps-crc.testing", "http:checkout.stripe.com/""
...
oc set env deployment/apollo-backend FRONTEND_URL=http://frontend-testing.apps-crc.testing
oc set env deployment/apollo-backend FRONTEND_IP=http://172.25.128.169:7777
oc set env deployment/apollo-backend BACKEND_URL=http://apollo-backend-testin.apps-crc.testing
